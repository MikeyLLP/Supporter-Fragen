...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const headings = [
        'Falsches Ticket (Unban)',
        '1.21 Server Nicht da',
        'Texturen Pack läd nicht',
        'Wann welche Events? Survival Server', 
        'Wie sieht eine Op-Fishing Rod aus?',
        'Warum keine Villager?',
        'Was ist Experience?',
        'Was ist Replenish?',
        'Was ist Soulbound?',
        'Was ist Telekinesis?',
        'Was ist Beheading?',
        'Was ist Silent Gaze?',
        'Was ist Rocket Saver?',
        'Hat man als Veteran Vorteile?',
        'Wie wird man Veteran?',
        'Überschrift 16',
        'Überschrift 17',
        'Überschrift 18',
        'Überschrift 19',
...
const aliases = {
    ...
    3: ["Tp", "Texturen Pack", "Support", "Error", "Fehler", "läd nicht"],
    4: ["events", "wann", "welche events"],
    5: ["fishing", "rod", "angeln", "OP"],
    6: ["Villagers", "keine villager", "Villis"],
    7: ["was ist", "Experience", "Enchantmens", "Enchantment", "Enchantments"],
    8: ["was ist", "Replenish", "Enchantmens", "Enchantment", "Enchantments"],
    9: ["was ist", " Soulbound", "Enchantmens", "Enchantment", "Enchantments"],
    10: ["was ist", "Telekinesis", "Enchantmens", "Enchantment", "Enchantments"],
    11: ["was ist", "Beheading", "Enchantmens", "Enchantment", "Enchantments"],
    12: ["was ist", "Silent Gaze", "Enchantmens", "Enchantment", "Enchantments"],
    13: ["was ist", "Rocket Saver", "Enchantmens", "Enchantment", "Enchantments"],
    14: ["Veteran", "Vorteile", "Ränge", "Rang"],
    15: ["Veteran", "Wie wird", "Ränge", "Rang", "bekommen"],
    16: ["aliases"],
    17: ["aliases"],
    18: ["aliases"],
    19: ["aliases"],
